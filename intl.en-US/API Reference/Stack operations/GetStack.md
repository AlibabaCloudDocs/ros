...
|Outputs|List|\[\{"Description": "Instance ID","OutputKey": "InstanceId","OutputValue": "i-a\*\*\*\*"\}\]|The output parameters of the stack. |
...
|TemplateDescription|String|Some description|The description of the stack. |
...
|DeletionProtection|String|Enabled|Specifies whether to enable deletion protection on the stack. Valid values:
...
|Key|String|usage|The key of tag N of the stack. |
|Value|String|test|The value of tag N of the stack. |
