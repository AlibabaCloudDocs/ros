...
|[PreviewStack](/intl.en-US/API Reference/Stack operations/PreviewStack.md)|Previews the stack to be created by using a specific template.|
...
|[ListTemplateVersions](/intl.en-US/API Reference/Template operations/ListTemplateVersions.md)|Queries one or more versions of a template.|
|[SetTemplatePermission](/intl.en-US/API Reference/Template operations/SetTemplatePermission.md)|Shares or unshares a template.|
|[GenerateTemplatePolicy](/intl.en-US/API Reference/Template operations/GenerateTemplatePolicy.md)|Generates the policy information for a template.|
