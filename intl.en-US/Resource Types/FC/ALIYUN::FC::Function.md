...
|InstanceType|String|No|Yes|The type of the function instance.|Valid values:-   e1: flexible instance
...
|MemorySize|Integer|No|Yes|The memory size of the function.|Valid values:-   Valid values for a flexible instance: 128 to 3072. The value must be a multiple of 64.
...
|Property|Type|Required|Editable|Description|Constraint|
|--------|----|--------|--------|-----------|----------|
|Destination|Map|No|No|The destination of the asynchronous invocation.|For more information, see [Destination properties](#section_hbk_zbm_yp1).|
