...
-   false |
|VpcId|String|No|No|The Virtual Private Cloud \(VPC\) ID of the SLB instance.|None|
...
-   intranet: After an internal SLB instance is created, the system allocates an internal IP address to the instance so that the instance can forward only internal requests. |
|VSwitchId|String|No|No|The vSwitch ID of the SLB instance.|None|
...
|Tags|List|No|Yes|The tags to be added to the SLB instance.|A maximum of five tags can be added. For more information, see [Tags properties](/intl.en-US/Resource Types/SLB/ALIYUN::SLB::LoadBalancerClone.md). |
...
The available instance type varies based on regions. For more information about the instance types, see [FAQ about high-performance SLB instances](https://www.alibabacloud.com/help/doc-detail/85939.htm). |
...
|AddressIPVersion|String|No|No|The IP address version of the SLB instance.|Valid values:-   ipv4
-   ipv6

**Note:** When this parameter is set to ipv6, take note of the supported regions and specifications. |
...
To view more examples, visit [BackendServerAttachment.json](https://github.com/aliyun/ros-templates/tree/master/ResourceTemplates/SLB/JSON/BackendServerAttachment.json) and [BackendServerAttachment.yml](https://github.com/aliyun/ros-templates/tree/master/ResourceTemplates/SLB/YAML/BackendServerAttachment.yml). In the examples, the ALIYUN::SLB::LoadBalancer, ALIYUN::SLB::MasterSlaveServerGroup, and ALIYUN::SLB::BackendServerAttachment resource types are involved.
