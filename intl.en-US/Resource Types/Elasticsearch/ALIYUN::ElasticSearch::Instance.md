...
**Note:** It takes about 1 hour to create an Elasticsearch cluster, and 0.5 to 3 hours to update an Elasticsearch cluster. We recommend that you set the timeout period to 300 minutes for the stack creation request.
...
|InstanceChargeType|String|No|No|The billing method of the cluster.|Valid values: -   PrePaid: subscription
...
|EnablePublic|Boolean|No|Yes|Specifies whether to enable the public network access feature for the cluster.|Valid values:-   true
-   false |
...
|DiskType|String|Yes|Yes|The disk category of the data node.|Valid values: -   cloud\_ssd
-   cloud\_efficiency |
