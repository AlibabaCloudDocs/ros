...
-   [ALIYUN::ECS::NatGateway](/intl.en-US/Resource Types/ECS/ALIYUN::ECS::NatGateway.md): creates a NAT gateway for ECS instances in a VPC.
-   [ALIYUN::ECS::NetworkInterface](/intl.en-US/Resource Types/ECS/ALIYUN::ECS::NetworkInterface.md): creates an ENI.
-   [ALIYUN::ECS::NetworkInterfaceAttachment](/intl.en-US/Resource Types/ECS/ALIYUN::ECS::NetworkInterfaceAttachment.md): attaches an ENI to an ECS instance in a VPC.
-   [ALIYUN::ECS::NetworkInterfacePermission](/intl.en-US/Resource Types/ECS/ALIYUN::ECS::NetworkInterfacePermission.md): grants an account the permission to attach an ENI to an instance.
...
|Message Queue for Apache Kafka|[ALIYUN::KAFKA::Topic](/intl.en-US/Resource Types/KAFKA/ALIYUN::KAFKA::Topic.md): creates a topic.|
|Key Management Service \(KMS\)|-   [ALIYUN::KMS::Key](/intl.en-US/Resource Types/KMS/ALIYUN::KMS::Key.md): creates a customer master key \(CMK\).
-   [ALIYUN::KMS::Alias](/intl.en-US/Resource Types/KMS/ALIYUN::KMS::Alias.md): creates an alias for a CMK. |
...
|ApsaraDB for RDS|-   [ALIYUN::RDS::Account](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::Account.md): creates a database account for an ApsaraDB for RDS instance.
...
-   [ALIYUN::RDS::Database](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::Database.md): creates a database in an ApsaraDB for RDS instance.
-   [ALIYUN::RDS::DBInstance](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::DBInstance.md): creates an ApsaraDB for RDS instance.
-   [ALIYUN::RDS::DBInstanceParameterGroup](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::DBInstanceParameterGroup.md): modifies the parameters of an ApsaraDB for RDS instance.
-   [ALIYUN::RDS::DBInstanceSecurityIps](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::DBInstanceSecurityIps.md): modifies an IP address whitelist of an ApsaraDB for RDS instance.
-   [ALIYUN::RDS::PrepayDBInstance](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::PrepayDBInstance.md): creates a subscription ApsaraDB for RDS instance.
-   [ALIYUN::RDS::ReadOnlyDBInstance](/intl.en-US/Resource Types/RDS/ALIYUN::RDS::ReadOnlyDBInstance.md): creates a read-only instance for an ApsaraDB for RDS instance. |
...
|Resource Orchestration Service \(ROS\)|-   [ALIYUN::ROS::CustomResource](/intl.en-US/Resource Types/ROS/ALIYUN::ROS::CustomResource.md): creates a custom resource.
...
|Smart Access Gateway|-   [ALIYUN::SAG::ACLAssociation](/intl.en-US/Resource Types/SAG/ALIYUN::SAG::ACLAssociation.md): associates an access control list \(ACL\) with a Smart Access Gateway instance.
...
-   [ALIYUN::SAG::SmartAccessGatewayBinding](/intl.en-US/Resource Types/SAG/ALIYUN::SAG::SmartAccessGatewayBinding.md): binds a Smart Access Gateway instance to a specific CCN instance. |
...
-   [ALIYUN::VPC::Ipv6InternetBandwidth](/intl.en-US/Resource Types/VPC/ALIYUN::VPC::Ipv6InternetBandwidth.md): purchases an Internet bandwidth plan for an IPv6 address.
...
-   [ALIYUN::VPC::SnatEntry](/intl.en-US/Resource Types/VPC/ALIYUN::VPC::SnatEntry.md): adds a Source Network Address Translation \(SNAT\) entry to an SNAT table. |
