...
-   false |
|Configuration|String|是|否|规则动作的配置信息，传入格式为JSON String。|更多信息，请参见[CreateRuleAction](/cn.zh-CN/云端开发指南/云端API参考/云产品流转/CreateRuleAction.md)。|
|Type|String|是|否|规则动作类型。|更多信息，请参见[CreateRuleAction](/cn.zh-CN/云端开发指南/云端API参考/云产品流转/CreateRuleAction.md)。|
