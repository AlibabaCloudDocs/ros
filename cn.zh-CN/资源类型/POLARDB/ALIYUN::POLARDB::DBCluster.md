...
单位：月。 |
|ZoneId|String|否|否|可用区ID。|您可以通过[DescribeRegions](/cn.zh-CN/API参考/地域/DescribeRegions.md)接口查询可选的可用区。|
...
|DBNodeClass|String|是|否|节点规格。|更多信息，请参见[计费项概览](/cn.zh-CN/产品计费/计费项概览.md)。 |
