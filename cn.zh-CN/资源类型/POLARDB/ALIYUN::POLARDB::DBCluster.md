...
单位：月。 |
|ZoneId|String|否|否|可用区ID。|可调用[DescribeRegions](/cn.zh-CN/API参考/其他接口/DescribeRegions.md)接口进行查看。|
...
|DBNodeClass|String|是|否|节点规格。|详情请参见[规格与定价](/cn.zh-CN/产品定价/规格与定价.md)。 |
