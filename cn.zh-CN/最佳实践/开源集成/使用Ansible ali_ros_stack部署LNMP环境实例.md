...
确保您已经在Linux系统使用pip3安装并配置了Ansible模块，详情请参见[安装和配置Ansible]()。
...
2.  在编辑模式下，将以下完整的playbook示例代码粘贴到create\_lnmp.yml文件中。
    ...
    **说明：** ali\_ros\_stack模块参数详情，请参见[参数说明](/cn.zh-CN/常用工具/插件工具/Ansible/概览.md)。
      ...
      "Parameters": {
        ...
        "DBPassword": {
          ...
          "Description": {
            ...
            "zh-cn": "MySQL密码，长度为6~32个字符，可包含英文字符、数字和下划线（_）。"
          },
          "Label": "DB Password",
        ...
        "ZoneId": {
          ...
          "Description": {
            ...
            "zh-cn": "ECS可用区ID,</font><a href='https://help.aliyun.com/document_detail/123712.html' target='_blank'><b> 查看可用区信息</b><font color='blue'></a>"
          },
        ...
        "DBName": {
          ...
          "Description": {
            ...
            "zh-cn": "MySQL数据库名称，长度为1~64个英文或中文字符，必须以英文字符或中文字符开头，可以包含数字、下划线（_）、英文句点（.）和短划线（-）。"
          },
          "Label": "DB Name",
        ...
        "DBUser": {
          ...
          "Description": {
            ...
            "zh-cn": "MySQL数据库访问的用户名。长度不超过16个字符，必须以英文字符开头，可包含英文字符、数字和下划线（_）。"
          },
          "Label": "DB Username",
          "ConstraintDescription": "Must begin with a letter and contain only alphanumeric characters.",
          "MinLength": 1,
        ...
        "DBRootPassword": {
          ...
          "Description": {
            ...
            "zh-cn": "MySQL的root密码。 长度为6~32个字符，可包含英文字符、数字和下划线（_）。"
          },
        ...
        "InstanceType": {
          ...
          "Description": {
            ...
            "zh-cn": "ECS实例类型，进入产品控制台确保当前实例可用, <font><a href='https://help.aliyun.com/document_detail/25378.html' target='_blank'><b>查看实例类型</b></font color='blue'></a>"
          },
          "Label": "Instance Type",
        ...
        "SystemDiskCategory": {
          ...
          "Description": {
            ...
            "zh-cn": "系统磁盘类别：高效云盘（cloud_efficiency）或固态云盘（cloud_ssd）"
          },
          "AllowedValues": [
            "cloud_efficiency",
            "cloud_ssd"
        ...
        "InstancePassword": {
          ...
          "Description": {
            ...
            "zh-cn": "长度为8~30个字符，必须包含大写字母、小写字母、数字或特殊符号其中三种；<br>特殊字符包括：()`~!@#$%^&*_-+=|{}[]:;'<>,.?/"
          },
