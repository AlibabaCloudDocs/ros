...
|Namespace|String|是|是|产品的数据命名空间。|详情请参见[DescribeMetricMetaList](/intl.zh-CN/API参考/云产品时序指标类监控数据/DescribeMetricMetaList.md)或[监控项使用说明](/intl.zh-CN/附录1 云产品监控项/概述.md)。|
